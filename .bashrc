[ -z "$PS1" ] && return
PROMPT_DIRTRIM=2 #len of current working directory
...
export PS1="${debian_chroot:+($debian_chroot)}\[\033[01;32m\]Bash🍏\[\033[00m\]:\[\033[94m\]\w\[\033[93m\]\$(parse_git_branch)\[\033[00m\] $ "
